...
**aknowledgements**: [OpenNMT/CTranslate2](https://github.com/OpenNMT/CTranslate2)
...
|API|Alias|Trigger
|-|-|:-:|
|`/v1/translate`|`/v1/chat/completions`|Payload root element is `input`
|`/v1/generate`|`/v1/chat/completions`|Payload root element is `prompt`
|`/v1/rerank`||
